...
// TODO *Grant*: containerd setup server (grpc tcp trpc)
func New(ctx context.Context, config *srvconfig.Config) (*Server, error) {
	...
	var (
		...
		// TODO *Grant*: containerd create exchange event
	...
	for _, p := range plugins {
		...
		// TODO *Grant*: containerd write initcontext
		...
		// TODO *Grant*: containerd plugin set add
...
// of all plugins.
// TODO *Grant*: containerd load plugins
